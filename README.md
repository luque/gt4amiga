...
- [ ] Interactive DMACON/INTENA control panel (Bloc): click-to-toggle bits on top of the register model, replacing the code-level `enable:`/`disable:` calls with switches — the machine's "control panel" view.
